...
MATH_POSITIONS={
    '/':{'col': 3 , 'row': 2, 'character': '' , 'image path':{'light':'images/Newfolder/divide_dark-removebg-preview.png',
                                                                              'dark':'images/Newfolder/divide_dark-removebg-preview.png'}},
...
OPERATORS={
    ...
    'invert':{'col':1, 'row':2, 'text': '' , 'image path':{'light':'images/Newfolder/plus_minus_dark-removebg-preview.png',
                                                                              'dark':'images/Newfolder/plus_minus_light-removebg-preview.png'}},
